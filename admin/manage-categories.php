                                ...
                                <div class="demo-box m-t-20">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table m-0 table-bordered" id="example">
                                            ...
                                            <tbody>
                                                <?php 
                                       $query=mysqli_query($con,"Select id,category_name,description,posting_date,updation_date from  category where is_active=1");
                                       $cnt=1;
                                ...
                                <div class="demo-box m-t-20">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table m-0 table-bordered table-bordered-danger" id="example1">
                                            ...
                                            <tbody>
                                                <?php 
                                       $query=mysqli_query($con,"Select id,category_name,description,posting_date,updation_date from  category where is_active=0");
                                       $cnt=1;
                                       while($row=mysqli_fetch_array($query))
                                       {
                                       ?>

...
--><?php
   ...
   $subcat_description=$_POST['sucatdescription'];
   $query=mysqli_query($con,"update subcategory set category_id='$category_id',subcategory='$subcatname',subcat_description='$subcat_description' where subcategory_id='$subcatid'");
   if($query)
   {
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card-box">
                              ...
                              $subcatid=intval($_GET['scid']);
                              $query=mysqli_query($con,"Select category.category_name as catname,category.id as catid,subcategory.subcategory as subcatname,subcategory.subcat_description as subcat_description,subcategory.posting_date as subcatpostingdate,subcategory.updation_date as subcatupdationdate,subcategory.subcategory_id as subcatid from subcategory join category on subcategory.category_id=category.id where subcategory.is_active=1 and  subcategory_id='$subcatid'");
                              $cnt=1;
                              ...
                              ?>
                                <form class="row" name="category" method="post">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea class="form-control" rows="5" name="sucatdescription" required><?php echo htmlentities($row['subcat_description']);?></textarea>
                                    </div>
                                    <?php } ?>

...
$sql =mysqli_query($con,"SELECT admin_username,admin_emailid,admin_password,user_type FROM admin WHERE (admin_username='$uname' && admin_password='$password')");
...
<head>
    ...
    <!-- App title -->
    <title>  Bridge News | Admin Panel</title>

...
$password=md5($_POST['newpassword']);
        $query=mysqli_query($con,"select id from admin where  admin_emailid='$email' and admin_username='$username' ");
        
    $ret=mysqli_num_rows($query);
    if($ret>0){
      $query1=mysqli_query($con,"update admin set admin_password='$password'  where  admin_emailid='$email' && admin_username='$username' ");
       if($query1)
   {

...
$sql=mysqli_query($con,"SELECT admin_password FROM  admin where admin_username='$adminid' || admin_emailid='$adminid'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $dbpassword=$num['admin_password'];

if (password_verify($password, $dbpassword)) {

 $con=mysqli_query($con,"update admin set admin_password='$newhashedpass', updation_date='$currentTime' where admin_username='$adminid'");
